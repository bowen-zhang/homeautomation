...
class SecurityService(object):
    ...
    def RegisterNode(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ha.security.SecurityService/RegisterNode',
            security__pb2.RegisterNodeRequest.SerializeToString,
            security__pb2.RegisterNodeResponse.FromString,
